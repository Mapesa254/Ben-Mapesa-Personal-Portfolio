(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const i of e)if(i.type==="childList")for(const n of i.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function a(e){const i={};return e.integrity&&(i.integrity=e.integrity),e.referrerPolicy&&(i.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?i.credentials="include":e.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(e){if(e.ep)return;e.ep=!0;const i=a(e);fetch(e.href,i)}})();(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const e of r)if(e.type==="childList")for(const i of e.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function o(r){const e={};return r.integrity&&(e.integrity=r.integrity),r.referrerPolicy&&(e.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?e.credentials="include":r.crossOrigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function a(r){if(r.ep)return;r.ep=!0;const e=o(r);fetch(r.href,e)}})();/**
...
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const G=([t,o,a])=>{const r=document.createElementNS("http://www.w3.org/2000/svg",t);return Object.keys(o).forEach(e=>{r.setAttribute(e,String(o[e]))}),a!=null&&a.length&&a.forEach(e=>{const i=G(e);r.appendChild(i)}),r},te=(t,o={})=>{const a={...A,...o};return G(["svg",a,t])};/**
* @license lucide v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const re=t=>Array.from(t.attributes).reduce((o,a)=>(o[a.name]=a.value,o),{}),ae=t=>typeof t=="string"?t:!t||!t.class?"":t.class&&typeof t.class=="string"?t.class.split(" "):t.class&&Array.isArray(t.class)?t.class:"",oe=t=>t.flatMap(ae).map(o=>o.trim()).filter(Boolean).filter((o,a,r)=>r.indexOf(o)===a).join(" "),ne=t=>t.replace(/(\w)(\w*)(_|-|\s*)/g,(o,a,r)=>a.toUpperCase()+r.toLowerCase()),k=(t,{nameAttr:o,icons:a,attrs:r})=>{var e;const i=t.getAttribute(o);if(i==null)return;const n=ne(i),s=a[n];if(!s)return console.warn(`${t.outerHTML} icon name was not found in the provided icons object.`);const l=re(t),d={...A,"data-lucide":i,...r,...l},g=oe(["lucide",`lucide-${i}`,l,r]);g&&Object.assign(d,{class:g});const ee=te(s,d);return(e=t.parentNode)==null?void 0:e.replaceChild(ee,t)};/**
* @license lucide v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
...
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const V=[["circle",{cx:"12",cy:"12",r:"10"}],["path",{d:"M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"}],["path",{d:"M2 12h20"}]];/**
* @license lucide v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
...
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const q=[["path",{d:"M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"}],["rect",{width:"4",height:"12",x:"2",y:"9"}],["circle",{cx:"4",cy:"4",r:"2"}]];/**
* @license lucide v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
...
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/const x=[["path",{d:"M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z"}],["path",{d:"M20 3v4"}],["path",{d:"M22 5h-4"}],["path",{d:"M4 17v2"}],["path",{d:"M5 18H3"}]];/**
* @license lucide v0.487.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
...
lucide.createIcons({icons});\``);if(typeof document>"u")throw new Error("`createIcons()` only works in a browser environment.");const r=document.querySelectorAll(`[${o}]`);if(Array.from(r).forEach(e=>k(e,{nameAttr:o,icons:t,attrs:a})),o==="data-lucide"){const e=document.querySelectorAll("[icon-name]");e.length>0&&(console.warn("[Lucide] Some icons were found with the now deprecated icon-name attribute. These will still be replaced for backwards compatibility, but will no longer be supported in v1.0 and you should switch to data-lucide"),Array.from(e).forEach(i=>k(i,{nameAttr:"icon-name",icons:t,attrs:a})))}},K=[{id:"game",title:"Game Developer",description:"Building immersive 3D worlds and interactive experiences with deep focus on gameplay mechanics, physics simulation, and real-time rendering.",tags:["Unity","Unreal Engine","C#","GLSL","Blender"],iconName:"gamepad-2",gradient:"linear-gradient(135deg, #7c3aed, #a855f7, #c084fc)",glowColor:"rgba(168,85,247,0.35)",cardClass:"skill-card-game",accentColor:"#a855f7",bgGradientLight:"linear-gradient(135deg, rgba(255,255,255,0.85), rgba(255,255,255,0.65))",bgGradientDark:"linear-gradient(135deg, rgba(124,58,237,0.15), rgba(168,85,247,0.08))"},{id:"design",title:"Graphic Designer",description:"Creating visually striking brand identities, motion graphics, and UI/UX systems that blend aesthetics with intuitive user experiences.",tags:["Figma","Photoshop","Illustrator","After Effects","Spline"],iconName:"palette",gradient:"linear-gradient(135deg, #db2777, #ec4899, #f472b6)",glowColor:"rgba(236,72,153,0.35)",cardClass:"skill-card-design",accentColor:"#ec4899",bgGradientLight:"linear-gradient(135deg, rgba(255,255,255,0.85), rgba(255,255,255,0.65))",bgGradientDark:"linear-gradient(135deg, rgba(219,39,119,0.15), rgba(236,72,153,0.08))"},{id:"data",title:"Data Scientist",description:"Transforming complex datasets into actionable insights through machine learning models, statistical analysis, and interactive visualizations.",tags:["Python","TensorFlow","PyTorch","Pandas","Jupyter"],iconName:"bar-chart-3",gradient:"linear-gradient(135deg, #0891b2, #06b6d4, #22d3ee)",glowColor:"rgba(6,182,212,0.35)",cardClass:"skill-card-data",accentColor:"#06b6d4",bgGradientLight:"linear-gradient(135deg, rgba(255,255,255,0.85), rgba(255,255,255,0.65))",bgGradientDark:"linear-gradient(135deg, rgba(8,145,178,0.15), rgba(6,182,212,0.08))"}];let C=[...K];function me(){var t,o;const a=document.getElementById("skills-grid");if(!a)return;function r(){var e;let i="";C.forEach(n=>{const s=n.tags.map(l=>`<span class="px-3 py-1 rounded-full text-xs" style="
    ...
    `,t.innerHTML=o,c({icons:{Sparkles:x}}),window.observeElements&&window.observeElements()}function ye(){var t;const o=document.getElementById("contact-form"),a=document.getElementById("contact-success"),r=document.getElementById("contact-submit-btn");o&&(c({icons:{Mail:J,MapPin:v,Send:u,CheckCircle:P,Github:y,Twitter:Y,Linkedin:q,Globe:V}}),window.observeElements&&window.observeElements(),o.addEventListener("submit",e=>{e.preventDefault(),r&&(r.setAttribute("disabled","true"),r.innerHTML=`
                <div class="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin"></div>
                <span>Sending Message...</span>
            `),setTimeout(()=>{o.reset(),a&&a.classList.remove("hidden"),r&&(r.removeAttribute("disabled"),r.innerHTML=`
                ...
                `,c({icons:{Send:u}}))},1500)}),(t=document.getElementById("send-another-btn"))==null||t.addEventListener("click",()=>{a&&a.classList.add("hidden")}))}c({icons:{Sun:_,Moon:X,Menu:F,X:w,Zap:ge,Github:y,Twitter:Y,Linkedin:q,Globe:V,Mail:J,MapPin:v,MessageSquare:ce,CheckCircle:P,Send:u,Plus:Z,Gamepad2:O,Palette:W,BarChart3:B,ChevronRight:H,ArrowRight:ie,ExternalLink:U,ChevronDown:N,Sparkles:x,Play:de,Eye:R,ArrowUpRight:S,Heart:se,ArrowUp:le,Award:$,Code2:z,Calendar:I,Download:T}});const M=document.getElementById("theme-toggle"),D=document.documentElement;let p=!0;function Q(){p?D.classList.add("dark"):D.classList.remove("dark");const t=document.getElementById("theme-icon");t&&(t.innerHTML=p?'<i data-lucide="sun" class="w-4 h-4"></i>':'<i data-lucide="moon" class="w-4 h-4"></i>',c({icons:{Sun:_,Moon:X}}))}const ve=[{name:"Skills",fn:me},{name:"Projects",fn:be},{name:"About",fn:pe},{name:"Tools",fn:ue},{name:"Contact",fn:ye}];ve.forEach(({name:t,fn:o})=>{try{o()}catch(a){console.error(`Error initializing ${t}:`,a);const r=document.createElement("div");r.style.color="red",r.textContent=`Error in ${t}: `+a.toString(),document.body.prepend(r)}});Q();M==null||M.addEventListener("click",()=>{p=!p,Q()});const m=document.getElementById("navbar");window.addEventListener("scroll",()=>{window.scrollY>20?m==null||m.classList.add("scrolled"):m==null||m.classList.remove("scrolled")});const h=document.getElementById("mobile-menu-btn"),b=document.getElementById("mobile-menu");h==null||h.addEventListener("click",()=>{b==null||b.classList.toggle("hidden");const t=b==null?void 0:b.classList.contains("hidden");h.innerHTML=t?'<i data-lucide="menu" class="w-4 h-4"></i>':'<i data-lucide="x" class="w-4 h-4"></i>',c({icons:{Menu:F,X:w}})});const xe={rootMargin:"0px",threshold:.15},we=new IntersectionObserver((t,o)=>{t.forEach(a=>{a.isIntersecting&&(a.target.classList.add("animate-in"),o.unobserve(a.target))})},xe);window.observeElements=()=>{document.querySelectorAll(".reveal-on-scroll:not(.animate-in)").forEach(t=>{we.observe(t)})};window.observeElements();const E=["Game Developer","Graphic Designer","Data Scientist"];let f=0;const j=document.getElementById("hero-role");j&&setInterval(()=>{f=(f+1)%E.length,j.textContent=E[f]},2800);
